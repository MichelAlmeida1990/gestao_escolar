...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=10,
            help='Número de professores a criar (padrão: 10)',
        )
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            professores = self.criar_professores(options['professores'], disciplinas, turmas)
            ...
            livros = self.criar_livros(autores, editoras, categorias, 100)
        ...
        for serie_nome, serie_codigo in series:
            for turno in turnos:
                for letra in letras:
                    ...
                    if random.random() > 0.6:  # 40% de chance de criar
                        continue
    ...
    def criar_professores(self, quantidade, disciplinas, turmas):
        ...
        for i in range(quantidade):
            ...
            turmas_escolhidas = random.sample(turmas, min(num_turmas, len(turmas)))
